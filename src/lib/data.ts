...
export type WeeklyData = {
    ...
    acumuladoTienda: AcumuladoSeccionMes[];
    ventasWoman: {
        pesoComprador: VentasManItem[];
        zonaComercial: VentasManItem[];
        agrupacionComercial: VentasManItem[];
...
export function getInitialLists(): WeeklyData['listas'] {
    return {
        empleados: [
            ...
            { id: "79753", nombre: "BEATRIZ PEREZ JULVE" },
            { id: "409261", nombre: "BERTA MERCEDES MORELLI DELGADO" },
            ...
            { id: "410359", nombre: "LEYRE ORDOÑEZ VELASCO" },
            { id: "439383", nombre: "LORENA LOSTAO OLLES" },
            ...
            { id: "10535", nombre: "MARIA ARANZAZU VILLACAMPA-GINER GARCIA" },
            ...
            { id: "341289", nombre: "PABLO LOPEZ MOUCO" },
            { id: "340752", nombre: "PAOLA LOPEZ GASCA" },
            { id: "170224", nombre: "PATRICIA MARCO CORVINOS" },
            { id: "535946", nombre: "PEDRO RAMIREZ CANO" },
            { id: "467648", nombre: "RAFFAELA DE LIMA REZENDE" },
            ...
            { id: "479778", nombre: "SAMUEL RODRIGUEZ MUNOZ" },
...
const createAcumuladoMeses = (): AcumuladoSeccionMes[] => {
...
const createAcumuladoSeccion = (): AcumuladoSeccionData => ({
    woman: createAcumuladoMeses(),
    man: createAcumuladoMeses(),
    nino: createAcumuladoMeses(),
});
...
export function getInitialDataForWeek(weekId: string, lists: WeeklyData['listas']): WeeklyData {
    ...
    const createVentasCompradorNinoItems = (compradores: string[], zonas: string[]): VentasCompradorNinoItem[] => {
        ...
        return compradores.map(comprador => ({
            ...
            totalEuros: 0,
            totalUnidades: 0,
            mejoresFamilias: Array(5).fill({ nombre: '', totalEuros: 0, unidades: 0 }),
    ...
    return {
        ...
        acumuladoTienda: createAcumuladoMeses(),
        ventasWoman: {
