...
const ImageImportCard = ({ selectedRow, isEditing, onImageChange, imagePath }: { selectedRow: VentasWomanItem | null, isEditing: boolean, onImageChange: VentasWomanTabProps['onImageChange'], imagePath: string | null }) => {
