...
export function VentasNinoTab({ data, isEditing, onInputChange, onTextChange }: VentasNinoTabProps) {
    ...
    const { ventasNino, listas, datosPorSeccion, nino, logistica, almacenes, focusSemanal } = data;
